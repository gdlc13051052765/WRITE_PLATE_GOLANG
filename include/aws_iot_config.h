...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST            "a244sdkbxgj2hu.ats.iot.cn-north-1.amazonaws.com.cn" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT            8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID       "12467b16-7cad-572d-5bd4-ccf53377b641" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		 "Thing_cardWriterV2_12467b16-7cad-572d-5bd4-ccf53377b641" ///< Thing Name of the Shadow this device is associated with
...
#define MAX_SIZE_OF_THING_NAME 200 ///< The Thing Name should not be bigger than this value. Modify this if the Thing Name needs to be bigger
